...
const EMPTY = {
    ...
    name: "Löschen",
    color: "#333",
    image: "img/elemente/Zeichnung_Seite 6.png",
    category: "basic",
    calculateIncome: () => 0,
...
const RESIDENTIAL = {
    ...
    name: "Wohnhaus",
    color: "#2ecc71",
    image: "img/elemente/Zeichnung_Seite 8.png",
...
const COMMERCIAL = {
    ...
    name: "Gewerbe",
    color: "#3498db",
    image: "img/elemente/Zeichnung_Seite 11.png",
    category: "commercial",
...
const HOTEL = {
    ...
    name: "Hotel",
    color: "#e67e22",
    image: "img/elemente/Zeichnung_Seite 12.png",
    category: "commercial",
    calculateIncome: () => 1,
...
const INDUSTRIAL_PARK = {
    ...
    name: "Industriepark",
    color: "#d35400",
    image: "img/elemente/Zeichnung_Seite 14.png",
    category: "industrial",
    calculateIncome: () => 5,
    increasePopulation: () => 0,
    increaseCapacity: () => 0,
...
const FARM = {
    ...
    name: "Farm",
    color: "#27ae60",
    image: "img/elemente/Zeichnung_Seite 9.png",
    category: "industrial",
    calculateIncome: () => 1,
    increasePopulation: () => 0,
    increaseCapacity: () => 0,
...
const POWER_PLANT = {
    ...
    name: "Kraftwerk",
    color: "#f1c40f",
    image: "img/elemente/Zeichnung_Seite 13.png",
    category: "power",
    calculateIncome: () => 0,
    increasePopulation: () => 0,
...
const PARK = {
    ...
    name: "Park",
    color: "#27ae60",
    image: "img/elemente/Zeichnung_Seite 7.png",
    category: "public",
    calculateIncome: () => 0,
    increasePopulation: () => 0,
    increaseCapacity: () => 0,
